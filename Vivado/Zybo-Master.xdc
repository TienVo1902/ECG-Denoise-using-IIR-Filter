...
connect_debug_port u_ila_0/probe0 [get_nets [list {addr_wire[0]} {addr_wire[1]} {addr_wire[2]} {addr_wire[3]} {addr_wire[4]} {addr_wire[5]} {addr_wire[6]} {addr_wire[7]} {addr_wire[8]} {addr_wire[9]} {addr_wire[10]} {addr_wire[11]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 24 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {douta_wire[0]} {douta_wire[1]} {douta_wire[2]} {douta_wire[3]} {douta_wire[4]} {douta_wire[5]} {douta_wire[6]} {douta_wire[7]} {douta_wire[8]} {douta_wire[9]} {douta_wire[10]} {douta_wire[11]} {douta_wire[12]} {douta_wire[13]} {douta_wire[14]} {douta_wire[15]} {douta_wire[16]} {douta_wire[17]} {douta_wire[18]} {douta_wire[19]} {douta_wire[20]} {douta_wire[21]} {douta_wire[22]} {douta_wire[23]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 40 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {filtered_ecg_wire[0]} {filtered_ecg_wire[1]} {filtered_ecg_wire[2]} {filtered_ecg_wire[3]} {filtered_ecg_wire[4]} {filtered_ecg_wire[5]} {filtered_ecg_wire[6]} {filtered_ecg_wire[7]} {filtered_ecg_wire[8]} {filtered_ecg_wire[9]} {filtered_ecg_wire[10]} {filtered_ecg_wire[11]} {filtered_ecg_wire[12]} {filtered_ecg_wire[13]} {filtered_ecg_wire[14]} {filtered_ecg_wire[15]} {filtered_ecg_wire[16]} {filtered_ecg_wire[17]} {filtered_ecg_wire[18]} {filtered_ecg_wire[19]} {filtered_ecg_wire[20]} {filtered_ecg_wire[21]} {filtered_ecg_wire[22]} {filtered_ecg_wire[23]} {filtered_ecg_wire[24]} {filtered_ecg_wire[25]} {filtered_ecg_wire[26]} {filtered_ecg_wire[27]} {filtered_ecg_wire[28]} {filtered_ecg_wire[29]} {filtered_ecg_wire[30]} {filtered_ecg_wire[31]} {filtered_ecg_wire[32]} {filtered_ecg_wire[33]} {filtered_ecg_wire[34]} {filtered_ecg_wire[35]} {filtered_ecg_wire[36]} {filtered_ecg_wire[37]} {filtered_ecg_wire[38]} {filtered_ecg_wire[39]}]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets clk_out1_wire]
